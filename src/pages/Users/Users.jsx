...
const Users = () => {
  ...
  const [currentUser, setCurrentUser] = useState({ name: "", channel: "", shift: "" });
  ...
  const handleCreateUser = async () => {
    ...
    try {
      if (currentUser._id) {
        const response = await axios.put(`/users/${currentUser._id}`, currentUser);
  ...
  return (
    <div className="users-container">
      ...
      <button className="edit-btn add-user-btn" onClick={() => setModalOpen(true)}>
        <BiSolidUserPlus />
      </button>
